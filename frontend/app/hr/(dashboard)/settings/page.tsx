...
export default function HrSettingsPage() {
  ...
  const toggles = [
    ...
    { key: "semanticEnabled" as const, label: "Semantic Scoring", desc: "Enable SBERT for more accurate matching.", icon: Brain },
    { key: "biasAudit" as const, label: "Bias Audit", desc: "Run bias detection on every screening.", icon: Search },
    { key: "autoCompare" as const, label: "Auto-Compare Ties", desc: "Automatically flag tied candidates for comparison.", icon: FileText },
  ];
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-wrap items-center justify-between gap-4">
        <div>
          <h1 className="display-title text-2xl md:text-3xl text-white">HR Settings</h1>
          <p className="mt-1 text-sm text-zinc-400">Configure your hiring pipeline defaults.</p>
        </div>
